<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        ...
        @can('integration-module')
            <li class="menu-item {{ Request::routeIs('integration.*') ? 'active' : '' }}">
                <a href="{{ route('integration.index') }}" class="menu-link">
                    <i class="menu-icon">
                    ...
                    <div data-i18n="Analytics">Integrations</div>
                </a>
            </li>
        @endcan
        ...
        <li class="menu-item {{ Request::routeIs('banner.*') ? 'active' : '' }}">
            <a href="{{ route('banner.index') }}" class="menu-link">
                <i class="menu-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M6 22q-.825 0-1.412-.587T4 20V4q0-.825.588-1.412T6 2h12q.825 0 1.413.588T20 4v16q0 .825-.587 1.413T18 22zm0-2h12V4H6zm5.25-3.5L10.1 15q-.15-.2-.4-.2t-.4.2l-1.675 2.2q-.2.25-.063.525t.463.275h7.95q.325 0 .462-.275t-.062-.525l-2.425-3.175q-.15-.2-.4-.2t-.4.2zM6 20V4z"/></svg>
                </i>
        ...
        <li class="menu-item {{ Request::routeIs('blog.*') ? 'active' : '' }}">
            <a href="{{ route('blog.index') }}" class="menu-link">
                <i class="menu-icon">
                    <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 2048 2048"><path fill="currentColor" d="M2048 0v1536H731l-475 475v-475H0V0zM128 128v256h1792V128zm1792 1280V512H128v896h256v293l293-293zm-640-768h512v640h-512zm128 512h256V768h-256zM256 768h896v128H256zm0 256h896v128H256z"/></svg>
                </i>
