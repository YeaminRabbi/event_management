...
@section('content')
    <div class="container-xxl flex-grow-1 container-p-y">
        ...
        <div class="d-flex justify-content-between">
            <div>
                <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">FAQ /</span> list</h4>
            </div>
            <div class="my-auto">
                <a href="{{ route('faq.create') }}">
                    <button class="btn btn-info rounded-pill">Add FAQ</button>
                </a>
            </div>
        </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="form-check form-switch">
                                            <input class="form-check-input faq-status-toggle" type="checkbox"
                                                id="flexSwitchCheckDefault{{ $data->id }}"
                                                data-faq-id="{{ $data->id }}" {{ $data->status ? 'checked' : '' }}>
                                        </div>
                                    </td>
...
@section('js')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            const toggles = document.querySelectorAll('.faq-status-toggle');
