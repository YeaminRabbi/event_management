<section id="speaker-section" class="speaker-section clearfix">
    <div class="jarallax" style="background-image: url({{ asset('frontendpanel/assets/images/speaker/Black-White-Dubai-Wallpaper.jpg)') }}">
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6 col-md-12 col-sm-12">
                                    <div class="speaker-image image-wrapper text-center">
                                        <img src="{{ asset('frontendpanel/assets/images/speaker/speakes1.png') }}" alt="Image_not_found">
                        ...
                        <div class="item">
                            <div class="item-content">
                                <span class="speaker-thumbnail">
                                    <img src="{{ asset('frontendpanel/assets/images/speaker/speakes-thumbnail.png') }}"
                                        alt="Image_not_found">
                                </span>
